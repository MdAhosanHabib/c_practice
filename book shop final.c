...
main()
{
    ...
    {
        {
            "Niton","C Language",245.00,"May",1977,"PHI",15
        },
        {
            "Hazari","Chemistry",550.00,"Jan",2001,"OUP",20
        },
        {
            "Topon", "Physics", 527.50,"Nov",2012,"WILEY",15
        },
        {
    ...
    printf("\t\t\t THANK YOU....!!!!\n");
    printf("\n\n");
    printf("\t\t\t This software is\n");
    printf("\t\t\tDesigned By: APOLLO-5\n");
    printf("\t\t\twww.apollo_5.com\n\n\n");
    }
    void get(char string[])
    {
        char c;
